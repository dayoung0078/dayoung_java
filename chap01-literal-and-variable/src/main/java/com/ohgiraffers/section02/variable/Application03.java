...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        *       int age;
                Age = 10;
        *   1-4. 변수명은 숫자로 시작할 수 없다. int 4num;
    ...
    2-1. 변수명의 길이는 제한이 없다.
        int flsdfjsdljfldsjfdlsjflds;
    2-2. 변수명의 합성어로 이루어진 첫 단어는 소문자, 두번째 시작 단어는 대문자로 시작한다. (camel-case)
        int MaxNum;
    2-3. 단어와 단어 사이의 연결을 언더스코어로(_) 하지 않는다.
    // final int MAX_NUM; // final <-예외
    2-4. 한글로 변수명을 짓는 것이 가능하지만, 권장하지 않는다.(전세계적으로 쓰니까)
        int 숫자;
    ...
    2-8. boolean 형은 의문문으로 가급적 긍정형태로 작성한다. (true or false)
